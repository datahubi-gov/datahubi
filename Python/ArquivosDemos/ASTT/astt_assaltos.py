...
lista_tipos = ['Assalto','Assalto arma de fogo','Furto','Invasão','Veículo', 'Violência Mulher']
lista_tipos_peso = [0.3,0.1,0.1,0.05,0.4,0.05]
...
dados.to_csv('dados_astt_assaltos.csv',sep=";") #salva os registros